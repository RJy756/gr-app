...
PIE.merge(PIE.RendererBase, {
    ...
    getRadiiPixels: function( radii ) {
        var el = this.targetElement,
            ...
            w = bounds.w,
            h = bounds.h,
            tlX, tlY, qpz, trY, brX, brY, blX, blY, f;

        tlX = radii.x['tl'].pixels( el, w );
        tlY = radii.y['tl'].pixels( el, h );
        qpz = radii.x['tr'].pixels( el, w );
...
PIE.BackgroundRenderer = PIE.RendererBase.newRenderer( {
    ...
    /**
     * Draw all the background images layers
     */
    ...
    /**
     * Set the position and clipping of the background images for a layer
     * @param {Element} shape
     * @param {String} src
     * @param {number} index
     */
        ...
        PIE.Util.withImageSize( src, function( imgSize ) {
            ...
            if( elW && elH ) {
                var styleInfos = me.styleInfos,
                    ...
                    clipAdjust = PIE.ieVersion === 8 ? 0 : 1; //prior to IE8 requires 1 extra pixel in the images clip region
                ...
                // needed to fix antialiasing but makes the bg images fuzzy.
                ...
                shape.setFillAttrs(
                    ...
                    // Set the size of the images. We only set it if the images is scaled via background-size or by
                ...
                // Repeating - clip the images shape
    ...
    getBgClipPath: function( bounds, bgClip ) {
        ...
        // Add points at 0,0 and w,h so that the images size/position will still be
    ...
    /**
     * Hide the actual background images and color of the element.
     */
    ...
    draw: function() {
        ...
        PIE.Util.withImageSize( props.src, function( imgSize ) {
            ...
            function setSizeAndPos( rect, rectX, rectY, rectW, rectH, sliceX, sliceY, sliceW, sliceH ) {
                // Hide the piece entirely if we have zero dimensions for the images, the rect, or the slice
                var max = Math.max;
